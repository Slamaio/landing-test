<template>
  <header>
    <figure class="color-blur">
      ...
      >
        <g opacity="0.3" filter="url(#filter0_f_1_32)">
          <path
            fill-rule="evenodd"
            clip-rule="evenodd"
        ...
        <defs>
          ...
          >
            ...
            <feGaussianBlur stdDeviation="60" result="effect1_foregroundBlur_1_32" />
          </filter>
        </defs>
      </svg>
      <svg
        ...
        xmlns="http://www.w3.org/2000/svg"
      >
        <g opacity="0.3" filter="url(#filter0_f_1_33)">
          <path
            fill-rule="evenodd"
            clip-rule="evenodd"
        ...
        <defs>
          ...
          >
            <feFlood flood-opacity="0" result="BackgroundImageFix" />
            <feBlend mode="normal" in="SourceGraphic" in2="BackgroundImageFix" result="shape" />
            <feGaussianBlur stdDeviation="60" result="effect1_foregroundBlur_1_33" />
          </filter>
        </defs>
      </svg>
    </figure>
...
import TitleSearchComponent from './TitleSearch/TitleSearchComponent.vue'
import HighlightsComponent from './Highlights/HighlightsComponent.vue'
